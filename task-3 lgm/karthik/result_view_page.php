    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="info">
                ...
                <div class="add-class" style="margin-top: 20px;background-color: white;">
                    <h1 style="color: black;">Result</h1>
                    <table class="table table-hover table-striped table-condensed table-bordered">
                        <p style="font-size: 16pt;color: black;">Name: <?php echo $name; ?><br>Class: <?php echo $class; ?><br>Roll no: <?php echo $rn; ?></p>
