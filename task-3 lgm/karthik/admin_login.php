...
<body style="background-image: url(Images/black.jpg);background-size: cover;">
  <?php 
     include 'header.php'
     ?>
    ...
    <h1 style="margin-left: 41%; padding-top: 150px;color: white;">Admin Login Page</h1>
    <br>
  
    <div class="container-fluid">

   
    <div class="col-md-4-col-sm-4-col-xs-12" style="padding-top: 40px;">
