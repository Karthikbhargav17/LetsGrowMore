    ...
    <div class="wrapper">
        ...
        <?php include_once 'header.php' ?>
            <div class="info">
                ...
                <div class="add-class res" style="background: rgba(1,1,1,0.2)">
                    <h1 style="color:black;">Update Result</h1>
                    <form action="result_updatee.php" method="post" >
                        ...
                        <input class="text-input" type="text" name="Class" id="Stream" placeholder="Stream" value="<?= $class; ?>" readonly></div>
